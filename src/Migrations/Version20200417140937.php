 ...
 */
final class Version20200417140937 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE maladie DROP FOREIGN KEY FK_ADC4024BD65163A3');
        $this->addSql('DROP INDEX IDX_ADC4024BD65163A3 ON maladie');
        $this->addSql('ALTER TABLE maladie DROP bioagresseur_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE maladie ADD bioagresseur_id INT NOT NULL');
        $this->addSql('ALTER TABLE maladie ADD CONSTRAINT FK_ADC4024BD65163A3 FOREIGN KEY (bioagresseur_id) REFERENCES bioagresseur (id)');
        $this->addSql('CREATE INDEX IDX_ADC4024BD65163A3 ON maladie (bioagresseur_id)');
