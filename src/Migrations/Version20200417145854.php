 ...
 */
final class Version20200417145854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE observation ADD bioagresseurs_id INT NOT NULL, CHANGE coordonnees coordonnees VARCHAR(70) DEFAULT NULL');
        $this->addSql('ALTER TABLE observation ADD CONSTRAINT FK_C576DBE0A8781E14 FOREIGN KEY (bioagresseurs_id) REFERENCES bioagresseur (id)');
        $this->addSql('CREATE INDEX IDX_C576DBE0A8781E14 ON observation (bioagresseurs_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE observation DROP FOREIGN KEY FK_C576DBE0A8781E14');
        $this->addSql('DROP INDEX IDX_C576DBE0A8781E14 ON observation');
        $this->addSql('ALTER TABLE observation DROP bioagresseurs_id, CHANGE coordonnees coordonnees VARCHAR(70) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
